...
За вторую неделю почти доделан неожиданный эвент -- контрольная (Чуев Артём), картинки университетских корпусов (Суховицкая Марина), работа над изометрией в игре (Никитина Мария, пока в игру не добавлено, а существует как отдельный файл с заготовками)
